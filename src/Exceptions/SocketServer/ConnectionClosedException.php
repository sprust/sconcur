...
/**
 * A write to a socket connection failed because the connection is gone (the peer
 * disconnected, or it was closed). A runtime failure: the handler can catch it to
