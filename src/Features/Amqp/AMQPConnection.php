        ...
        $result = $this->runCommand(
            payload: new ConnectPayload(
                new ConnectPayloadParameters(
                    ...
                    readTimeoutMs: static::toMilliseconds($this->readTimeout),
                    writeTimeoutMs: static::toMilliseconds($this->writeTimeout),
                    rpcTimeoutMs: static::toMilliseconds($this->rpcTimeout),
