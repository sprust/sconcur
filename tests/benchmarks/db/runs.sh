...
# percentages) by tests/benchmarks/db/runs-aggregate.php into markdown rows for
# docs/benchmarks.md.
#
...
#
# Usage:
#   tests/benchmarks/db/runs.sh                 # all DB benches
#   tests/benchmarks/db/runs.sh mysql-insert    # a subset (uses default calls)
#   RUNS=2 DATASET=1000 tests/benchmarks/db/runs.sh   # smoke run
#
...
$DOCKER_COMPOSE exec -T php php "tests/benchmarks/db/runs-aggregate.php" "$OUT_DIR"
