#!/usr/bin/env bash
#
# Swoole counterpart of load-stats.sh / rr-load-stats.sh: the same load +
...
# directly comparable with load-stats.sh / rr-load-stats.sh runs at the same
...
#   WORKERS=8 CONNECTIONS=256 DURATION=20 tests/benchmarks/http/swoole-load-stats.sh
#
