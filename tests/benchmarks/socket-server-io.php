...
// frame (the handler sleeps 1s asynchronously, yielding to the scheduler) against
// the running `servers` socket pool. For I/O work a single cooperative process
// already overlaps all the sleeps, so the pool's total time stays ≈ one sleep
