...
/**
 * Covers the SocketServer `masterPid` orphan-check in isolation: the server is a
 ...
 */
class SocketServerMasterPidTest extends TestCase
{
    public function testKeepsServingWhenMasterPidIsItsParent(): void
    {
        ...
        $server = TestSocketServer::start(['masterPid' => (int) getmypid()]);
