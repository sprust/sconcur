...
[Версии, на которых тестировалось](../README.md#версии-на-которых-тестировалось)
в главном README: расширение собрано под конкретные версии PHP, Go и серверов
(MongoDB, MySQL, PostgreSQL), и совместимость гарантируется только с ними.
