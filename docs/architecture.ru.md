...
готовые (до 64). Планировщик разбирает пачку по одному результату за шаг: кадр
результата сам называет ожидающую его корутину, её планировщик и возобновляет.
